...
export default function FilesTable({ generateTickets, response, ticketsResponse, isPolling }) {
        ...
        <table className="w-full divide-y divide-gray-300">
            ...
            <thead>
                <tr>
                    ...
                    <th scope="col" className="py-3 text-left text-sm font-semibold text-white">File Name and URL</th>
                </tr>
            </thead>
                ...
                {Object.entries(response.files).map(([index, { name, url, size }]) => (
                    <tr key={index}>
                        ...
                        <td className="py-3 text-sm text-gray-500">
                            ...
                            <a
                                className="text-blue-600 hover:text-[#4654A3] text-xs"
                                href={url}
                                target="_blank"
                            >
                                {url}
